...
| | |
|---|---|
| Entry points inventariados | 118 (117 en el cierre 2026-08-02; +1 en el tren 3 de Stella: `app/actions/stella/grounded-query.ts`) |
| Alcanzan `db/client.ts` | 94 |
...
| Escáner AST | 119 módulos / 97 alcanzan BD / 84 contextualizados + 13 allowlist / **0 sin guardia**; 10 fixtures mutantes; con la forma antigua de `OutcomeAllocationWrapper` reinsertada, fallan 4 pruebas (verificado empíricamente) |
