      ...
      {sections.map(({ id, label }) => {
        ...
        return (
          <a
            ...
            tabIndex={-1}
            aria-label={label}
            className="group flex items-center gap-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FF6A00] rounded-sm"
          >
            <span
              className={`rounded-full transition-all duration-200 ${
                isActive
                  ? "h-2 w-2 bg-[#FF6A00] scale-110"
