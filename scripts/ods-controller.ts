...
// ag1_disposition.immutableByConvention.entries (20) + v1.0.10 + v1.0.11 + v1.0.12 + v1.0.13 + v1.0.14 + v1.0.15 + v1.0.16 + v1.0.17 + v1.0.18 + v1.0.19 + v1.0.20 + v1.0.21 + v1.0.22 + v1.0.23 + v1.0.24 + v1.0.25 + v1.0.26 + v1.0.27 + v1.0.28 + v1.0.29 + v1.0.30 + v1.0.31 + v1.0.32 + v1.0.33 + v1.0.34 + v1.0.35 + v1.0.36 + v1.0.37 + v1.0.38 + v1.0.39. EXACT membership — never a subset test.
export const IMMUTABLE_BY_CONVENTION: readonly string[] = [
  ...
  'docs/ops/ods/ODS_V1_MAINTENANCE_ADDENDUM_v1.0.39.json',
] as const
