    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-5">
          ...
          <div className="mt-1 text-3xl font-semibold text-white">12</div>
        </div>
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-5">
          <div className="text-sm font-medium text-slate-400 truncate">Total Usuarios</div>
          <div className="mt-1 text-3xl font-semibold text-white">48</div>
        </div>
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-5">
          <div className="text-sm font-medium text-slate-400 truncate">Proxies Globales</div>
          <div className="mt-1 text-3xl font-semibold text-white">142</div>
        </div>
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-5">
          <div className="text-sm font-medium text-slate-400 truncate">Logs de Auditoría</div>
          <div className="mt-1 text-3xl font-semibold text-white">1,204</div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-lg p-6">
        ...
        <div className="flex gap-4">
          <button className="rounded-md bg-red-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 transition-colors">
            Ver Logs Globales
          </button>
          <button className="rounded-md bg-slate-800 border border-slate-700 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-700 transition-colors">
