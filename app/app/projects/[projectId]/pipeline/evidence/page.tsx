...
import { StellaAdvisorPanelWrapper, StellaReviewerPanel } from '@/components/stella'
...
export default async function EvidencePage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      ...
      <StellaAdvisorPanelWrapper projectId={projectId} step="Evidencia" highlightHint={evidences.length === 0} />
