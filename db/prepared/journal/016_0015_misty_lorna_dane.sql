-- ============================================================================
-- GENERATED — DO NOT EDIT. Unit 16/65: 0015_misty_lorna_dane.sql
-- ============================================================================
--
-- Includes:      db/migrations/0015_misty_lorna_dane.sql
-- Source SHA256: a5c05d3fc4c563c15cc16f9ba620310f64e96bee9bc6f8784992328c9860b05a
--
...
--        -f db/prepared/journal/016_0015_misty_lorna_dane.sql
--
-- ============================================================================
...
\ir ../../../db/migrations/0015_misty_lorna_dane.sql
...
VALUES
  ('staging', :'uellix_project_ref', '0015_misty_lorna_dane.sql', 'PHASE_BASELINE',
   'a5c05d3fc4c563c15cc16f9ba620310f64e96bee9bc6f8784992328c9860b05a', NULL, NULL, 'APPLIED');
