-- ============================================================================
-- GENERATED — DO NOT EDIT. Unit 74/74: 0061_fib_disposition_governance_function_execute_revocation.sql
-- ============================================================================
--
-- Includes:      db/migrations/0061_fib_disposition_governance_function_execute_revocation.sql
-- Source SHA256: 3aeb49965697bee70b14fb59f8f5ff43cd3e15279c39d12575fe703867b646e7
--
...
--        -f db/prepared/journal/074_0061_fib_disposition_governance_function_execute_revocation.sql
--
-- ============================================================================
...
\ir ../../../db/migrations/0061_fib_disposition_governance_function_execute_revocation.sql
...
VALUES
  ('staging', :'uellix_project_ref', '0061_fib_disposition_governance_function_execute_revocation.sql', 'PHASE_BASELINE',
   '3aeb49965697bee70b14fb59f8f5ff43cd3e15279c39d12575fe703867b646e7', NULL, NULL, 'APPLIED');
