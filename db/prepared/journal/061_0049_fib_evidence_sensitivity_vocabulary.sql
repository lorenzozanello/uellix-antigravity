-- ============================================================================
-- GENERATED — DO NOT EDIT. Unit 61/74: 0049_fib_evidence_sensitivity_vocabulary.sql
-- ============================================================================
--
-- Includes:      db/migrations/0049_fib_evidence_sensitivity_vocabulary.sql
-- Source SHA256: 3fcec066bdca95b6428641ca4cb22b9057fcea8ccc890b3fc70ffbb366256af5
--
...
--        -f db/prepared/journal/061_0049_fib_evidence_sensitivity_vocabulary.sql
--
-- ============================================================================
...
\ir ../../../db/migrations/0049_fib_evidence_sensitivity_vocabulary.sql
...
VALUES
  ('staging', :'uellix_project_ref', '0049_fib_evidence_sensitivity_vocabulary.sql', 'PHASE_BASELINE',
   '3fcec066bdca95b6428641ca4cb22b9057fcea8ccc890b3fc70ffbb366256af5', NULL, NULL, 'APPLIED');
