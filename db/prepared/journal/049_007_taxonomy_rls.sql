-- ============================================================================
-- GENERATED — DO NOT EDIT. Unit 49/64: 007_taxonomy_rls.sql
-- ============================================================================
--
-- Includes:      db/policies/007_taxonomy_rls.sql
-- Source SHA256: 3a33a1bf60520363402a696211faff3f5e755b2326a457f438ac9171b409b34d
--
...
--        -f db/prepared/journal/049_007_taxonomy_rls.sql
--
-- ============================================================================
...
\ir ../../../db/policies/007_taxonomy_rls.sql
...
VALUES
  ('staging', :'uellix_project_ref', '007_taxonomy_rls.sql', 'PHASE_BASELINE',
   '3a33a1bf60520363402a696211faff3f5e755b2326a457f438ac9171b409b34d', NULL, NULL, 'APPLIED');
