-- ============================================================================
-- GENERATED — DO NOT EDIT. Unit 24/71: 0023_faulty_silver_sable.sql
-- ============================================================================
--
-- Includes:      db/migrations/0023_faulty_silver_sable.sql
-- Source SHA256: 8f75bde661c36a70ef378784965173001d7e10b871c22a9cbf6052a5aff06eb8
--
...
--        -f db/prepared/journal/024_0023_faulty_silver_sable.sql
--
-- ============================================================================
...
\ir ../../../db/migrations/0023_faulty_silver_sable.sql
...
VALUES
  ('staging', :'uellix_project_ref', '0023_faulty_silver_sable.sql', 'PHASE_BASELINE',
   '8f75bde661c36a70ef378784965173001d7e10b871c22a9cbf6052a5aff06eb8', NULL, NULL, 'APPLIED');
