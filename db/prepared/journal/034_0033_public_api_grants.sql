-- ============================================================================
-- GENERATED — DO NOT EDIT. Unit 34/59: 0033_public_api_grants.sql
-- ============================================================================
--
-- Includes:      db/migrations/0033_public_api_grants.sql
-- Source SHA256: 73c03e579c1f2ce0b9a8db11911dbfff1ec26bc4b1509527f3ab24a935c8dfef
--
...
--        -f db/prepared/journal/034_0033_public_api_grants.sql
--
-- ============================================================================
...
\ir ../../../db/migrations/0033_public_api_grants.sql
...
VALUES
  ('staging', :'uellix_project_ref', '0033_public_api_grants.sql', 'PHASE_BASELINE',
   '73c03e579c1f2ce0b9a8db11911dbfff1ec26bc4b1509527f3ab24a935c8dfef', NULL, NULL, 'APPLIED');
