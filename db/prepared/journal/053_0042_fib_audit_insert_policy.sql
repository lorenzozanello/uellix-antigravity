-- ============================================================================
-- GENERATED — DO NOT EDIT. Unit 53/63: 0042_fib_audit_insert_policy.sql
-- ============================================================================
--
-- Includes:      db/migrations/0042_fib_audit_insert_policy.sql
-- Source SHA256: 5812a4ee760c7a68c4f0e0828cd37050efd728166eb950c58839e07bf911a9f5
--
...
--        -f db/prepared/journal/053_0042_fib_audit_insert_policy.sql
--
-- ============================================================================
...
\ir ../../../db/migrations/0042_fib_audit_insert_policy.sql
...
VALUES
  ('staging', :'uellix_project_ref', '0042_fib_audit_insert_policy.sql', 'PHASE_BASELINE',
   '5812a4ee760c7a68c4f0e0828cd37050efd728166eb950c58839e07bf911a9f5', NULL, NULL, 'APPLIED');
