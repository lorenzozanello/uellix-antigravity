-- ============================================================================
-- stella_0016_reserved_quota_semantics — GOVERNED MANAGED SUPABASE VARIANT
...
-- ============================================================================
-- ============================================================================
-- stella_0016_reserved_quota_semantics — MANAGED SUPABASE VARIANT
-- GENERATED — DO NOT EDIT. Regenerate with `pnpm hosted:generate`.
-- ============================================================================
--
-- Derived from: db/prepared/stella_0016_reserved_quota_semantics.sql
-- Source SHA-256 (LF-normalized): 5eb6946438b810cfdca580e9c958b7bb90783a9691ada722efca75653a58baec
--
...
BEGIN
  ...
  --   stella_0016 aborted: must run as a SUPERUSER (current_user=%). It transfers function ownership to a capability role and grants column-level SELECT on a table it does not own.
  PERFORM uellix_bootstrap.assert_hosted_capabilities('stella_0016_reserved_quota_semantics');
...
-- authority: close W37.S1
-- authority: open W38.S1 (CAPABILITY) as uellix_cap_stella_quota
...
REVOKE CREATE ON SCHEMA uellix_stella_ops FROM uellix_cap_stella_ticket;
RESET ROLE;
REVOKE uellix_cap_stella_ticket FROM uellix_owner;
-- authority: close W39.S1
-- authority: open W40.S1 (CAPABILITY) as uellix_cap_stella_ticket
GRANT uellix_cap_stella_ticket TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_ticket;
