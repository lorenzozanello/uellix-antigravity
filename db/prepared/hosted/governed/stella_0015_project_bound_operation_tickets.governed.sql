-- ============================================================================
-- stella_0015_project_bound_operation_tickets — GOVERNED MANAGED SUPABASE VARIANT
...
BEGIN
  ...
  END IF;
END $$;
-- authority: open W29.S1 (CAPABILITY) as uellix_cap_stella_ticket
...
-- authority: close W31.S1
-- authority: open W32.S1 (CAPABILITY) as uellix_cap_stella_ticket
GRANT uellix_cap_stella_ticket TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_ticket;
