-- ============================================================================
-- grounding_0002_document_versions — GOVERNED MANAGED SUPABASE VARIANT
...
-- ============================================================================
-- ============================================================================
-- grounding_0002_document_versions — MANAGED SUPABASE VARIANT
-- GENERATED — DO NOT EDIT. Regenerate with `pnpm hosted:generate`.
-- ============================================================================
--
-- Derived from: db/prepared/grounding_0002_document_versions.sql
-- Source SHA-256 (LF-normalized): 92a2b3bca658b7a2a5fda925b099e74cec758d202edcb77f3d16438df2c05f09
--
...
BEGIN
  ...
  --   grounding_0002 aborted: must run as a SUPERUSER (current_user=%). It creates a role, and uellix_owner is NOCREATEROLE by design — granting it CREATEROLE would undo stella_0004.
  PERFORM uellix_bootstrap.assert_hosted_capabilities('grounding_0002_document_versions');
...
ALTER ROLE uellix_cap_grounding NOLOGIN NOCREATEROLE NOINHERIT;
...
-- authority: close W04.S1
-- authority: open W05.S1 (CAPABILITY) as uellix_cap_grounding
