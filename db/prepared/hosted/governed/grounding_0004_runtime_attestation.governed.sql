-- ============================================================================
-- grounding_0004_runtime_attestation — GOVERNED MANAGED SUPABASE VARIANT
...
-- authority: close W12.S1
-- authority: open W13.S1 (CAPABILITY) as uellix_cap_grounding
