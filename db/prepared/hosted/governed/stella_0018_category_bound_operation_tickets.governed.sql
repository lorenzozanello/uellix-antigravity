-- ============================================================================
-- stella_0018_category_bound_operation_tickets — GOVERNED MANAGED SUPABASE VARIANT
...
-- authority: close W50.S1
-- authority: open W51.S1 (CAPABILITY) as uellix_cap_stella_ticket
GRANT uellix_cap_stella_ticket TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_ticket;
...
RESET ROLE;
REVOKE uellix_cap_stella_ticket FROM uellix_migrator;
-- authority: close W51.S1
-- authority: open W51.S2 (CAPABILITY) as uellix_cap_stella_quota
