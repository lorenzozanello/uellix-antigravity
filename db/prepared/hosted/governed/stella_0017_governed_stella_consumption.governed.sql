-- ============================================================================
-- stella_0017_governed_stella_consumption — GOVERNED MANAGED SUPABASE VARIANT
...
-- authority: close W46.S1
-- authority: open W46.S2 (OWNER_TRANSFER) as uellix_owner
...
-- authority: close W46.S2
-- authority: open W47.S1 (CAPABILITY) as uellix_cap_stella_quota
GRANT uellix_cap_stella_quota TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_quota;
...
RESET ROLE;
REVOKE uellix_cap_stella_quota FROM uellix_migrator;
-- authority: close W47.S1
-- authority: open W47.S2 (CAPABILITY) as uellix_cap_stella_ticket
...
-- authority: close W47.S2
-- authority: open W47.S3 (CAPABILITY) as uellix_cap_stella_quota
GRANT uellix_cap_stella_quota TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_quota;
...
RESET ROLE;
REVOKE uellix_cap_stella_quota FROM uellix_migrator;
-- authority: close W47.S3
-- authority: open W47.S4 (CAPABILITY) as uellix_cap_stella_ticket
GRANT uellix_cap_stella_ticket TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_ticket;
...
RESET ROLE;
REVOKE uellix_cap_stella_ticket FROM uellix_migrator;
-- authority: close W47.S4
-- authority: open W47.S5 (CAPABILITY) as uellix_cap_stella_quota
GRANT uellix_cap_stella_quota TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_quota;
...
RESET ROLE;
REVOKE uellix_cap_stella_quota FROM uellix_migrator;
-- authority: close W47.S5
-- authority: open W47.S6 (CAPABILITY) as uellix_cap_stella_ticket
GRANT uellix_cap_stella_ticket TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_stella_ticket;
