-- ============================================================================
-- grounding_0005_claim_advisory_lock — GOVERNED MANAGED SUPABASE VARIANT
-- GENERATED — DO NOT EDIT. Regenerate with `pnpm authority:generate`.
-- ============================================================================
--
-- Package: T10
-- Derived from: db/prepared/hosted/grounding_0005_claim_advisory_lock.hosted.sql
-- Source SHA-256 (LF-normalized): d112386727dd36c7873362d0a5ddb2f44efa1e9e283b22bc3fe0b84f0fd09a03
--
...
-- ============================================================================
-- ============================================================================
-- grounding_0005_claim_advisory_lock — MANAGED SUPABASE VARIANT
-- GENERATED — DO NOT EDIT. Regenerate with `pnpm hosted:generate`.
-- ============================================================================
--
-- Derived from: db/prepared/grounding_0005_claim_advisory_lock.sql
-- Source SHA-256 (LF-normalized): 62054fd1dda7e87184f98c013c6cb876fee03f592b4860e355e4de6be9064c58
--
...
BEGIN
  ...
  --   grounding_0005 aborted: must run as a SUPERUSER (current_user=%). It republishes a function owned by uellix_cap_grounding, which requires becoming that role and holding CREATE on schema uellix_grounding for the length of one statement.
  PERFORM uellix_bootstrap.assert_hosted_capabilities('grounding_0005_claim_advisory_lock');
  ...
  END IF;
END $$;
-- authority: open W52.S1 (CAPABILITY) as uellix_cap_grounding
...
-- authority: close W52.S1
-- authority: open W53.S1 (CAPABILITY) as uellix_cap_grounding
GRANT uellix_cap_grounding TO uellix_migrator WITH INHERIT FALSE, SET TRUE;
SET ROLE uellix_cap_grounding;
...
BEGIN
  ...
  --   grounding_0005 FAILED verification: uellix_cap_grounding has % member(s)
  PERFORM uellix_bootstrap.assert_capability_membership_topology('grounding_0005_claim_advisory_lock', 'uellix_cap_grounding');
