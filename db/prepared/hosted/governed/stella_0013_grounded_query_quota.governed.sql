-- ============================================================================
-- stella_0013_grounded_query_quota — GOVERNED MANAGED SUPABASE VARIANT
...
-- authority: close W18.S1
-- authority: open W19.S1 (CAPABILITY) as uellix_cap_stella_quota
