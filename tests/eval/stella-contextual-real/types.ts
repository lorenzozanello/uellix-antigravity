...
export interface DecodedResult { caseId: string; output: AdvisorContextualOutput; canonicalValidation: 'passed'; safety: 'passed'; schemaContract: 'passed'; numericIntegrity: 'passed'; requiresHumanReview: true }
