...
const EXPECTED_PROBE_IDS = [
  ...
  'PG-POS-1-same-tenant-UPDATE-sensitivity_candidates',
  ...
  'PG-POS-2-rationale-required-variation_required',
  'PG-POS-2-rationale-required-no_additional_variation_required',
  'PG-POS-2-combination_description-required-combined',
  'PG-POS-2-UNIQUE-readiness_assessments-per-run',
  'PG-POS-2-UNIQUE-sensitivity_candidates-per-run-key',
  'PG-POS-2-NOT-NULL-calculation_run_id',
  'PG-POS-3-FIBDB-016-column-comment-and-data-intact',
  ...
  'SEC-N5-no-DELETE-policy-readiness_assessments',
  'SEC-N5-no-DELETE-policy-sensitivity_candidates',
  'SEC-N5-no-DELETE-policy-sensitivity_scenarios',
  'SEC-N5-same-tenant-DELETE-denied-readiness_assessments',
  'SEC-N5-same-tenant-DELETE-denied-sensitivity_candidates',
  'SEC-N5-same-tenant-DELETE-denied-sensitivity_scenarios',
  'SEC-ACL-1-RLS-enabled-and-policies-exist-per-table',
  'SEC-ACL-1-uellix_writer-grants',
  'SEC-ACL-1-uellix_auditor-grants',
  'SEC-ACL-1-PUBLIC-holds-nothing',
  ...
  'MUT-PG-4-UPDATE-policy-addition-caught-readiness_assessments',
  'MUT-PG-4-UPDATE-policy-addition-caught-sensitivity_scenarios',
  'MUT-PG-5-nullable-calculation_run_id-caught-readiness_assessments',
  'MUT-PG-5-nullable-calculation_run_id-caught-sensitivity_candidates',
  'MUT-PG-5-nullable-calculation_run_id-caught-sensitivity_scenarios',
  'MUT-PG-6-column-comment-removal-caught',
]
